            ...
            <div className="container mx-auto relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    ...
                    <div className="p-8 rounded-2xl transition-all duration-300
                        ...
                        <p className="text-gray-300 dark:text-gray-300 light:text-gray-300 mb-6 leading-relaxed">
                            We scale our team based on project needs, bringing in the right expertise for every challenge.
                        </p>
                    ...
                    <div className="p-8 rounded-2xl transition-all duration-300
                        ...
                        <p className="text-gray-300 dark:text-gray-300 light:text-gray-300 mb-6 leading-relaxed">
                            Specializing in creating responsive, performant web applications with modern technologies.
                        </p>

                        <div className="mt-6 pt-6 border-t border-gray-700/50 dark:border-gray-700/50 light:border-gray-600/50">
                            <p className="text-sm font-medium text-gray-400 dark:text-gray-400 light:text-gray-400 mb-3">Expertise:</p>
                            <div className="flex flex-wrap gap-2">
                                {["React.js", "Next.js", "TypeScript", "Supabase", "UI/UX", "jQuery", "Bootstrap", "Material UI", "Tailwind CSS"].map((skill, idx) => (
                                    <span key={idx} className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gray-800/50 text-gray-300 border border-gray-700/50">
                                        {skill}
                                    </span>
                                ))}
                        ...
                        <div className="mt-6 flex space-x-4">
                            <a href="https://www.linkedin.com/in/yousef-hatem-16530024b/" target='_blank' className="text-gray-400 hover:text-blue-400 transition-colors duration-300">
                                <i className="fab fa-linkedin text-xl"></i>
                            </a>
                ...
                <div className="max-w-3xl mx-auto mt-12 p-6 rounded-2xl 
                    ...
                    <div className="flex items-center">
                        ...
                        <div>
                            <h3 className="text-lg font-bold text-white dark:text-white light:text-white">Expanding Team</h3>
                            <p className="text-gray-300 dark:text-gray-300 light:text-gray-300">
                                We collaborate with additional specialists based on project requirements, ensuring we have the right expertise for every challenge.
                            </p>
                        </div>
                    </div>
                </div>
